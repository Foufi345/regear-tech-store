...
import Logo from '/public/display/rigear-logo.svg'
...
<template>
	...
	>
		...
		>
			...
			<router-link
				to="/"
				class="tracking-tight antialiased transition duration-300 hover:scale-110"
				data-test="nav-logo"
			>
			<img
					class="h-14 hover:opacity-50 active:translate-y-0.5"
					:src="Logo"
					alt=""
				/>
			</router-link>
